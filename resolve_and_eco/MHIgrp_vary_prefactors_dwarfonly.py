...
def make_eco_group_cat(param):
    ...
    gfparams = dict({'volume':ecovolume,'rproj_fit_multiplier':2.5,'vproj_fit_multiplier':3.5,\
       'vproj_fit_offset':300,'gd_rproj_fit_multiplier':param[0], 'gd_vproj_fit_multiplier':param[1],\
    ...
    outfile = 'ic_prefac_eco_catls/'+'ECO_icgroupcatl__'+str(param[0])+'__'+str(param[1])+'__.csv'
...
if __name__=='__main__':
    write_catls=True
    if write_catls:
        params = [(1,1), (1.5,3.5), (3,5), (6,8), (10,10)]
