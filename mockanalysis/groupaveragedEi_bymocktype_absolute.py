...
if __name__=='__main__':
    ...
    for sd in subdirs:
        ...
        for fname in files:
            if i<30:
                ...
                mock.loc[:,'Ei'] = np.abs(mock.g3logmh_l-mock.loghalom)
    ...
    axd['B'].annotate("G3 Groups\n(Fiducial)",xy=(12.7,2),fontsize=10)
    axd['B'].set_ylim(0,2.5)
    ...
    axd['C'].annotate("G3 Groups\n(Central-Offset)",xy=(12.7,2),fontsize=10)
    axd['C'].set_ylim(0,2.5)
    ...
    for sd in subdirs:
        ...
        for fname in files:
            if i<30:
                ...
                mock.loc[:,'loghalom']=mock.loghalom-np.log10(HUBBLE_CONST/100.)
                mock.loc[:,'Ei'] = np.abs(mock.fofe17logmh-mock.loghalom)
