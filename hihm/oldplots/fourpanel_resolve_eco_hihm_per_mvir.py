...
def make_panel(cax,xv,yv,binvalues,xlim,ylim,xlab,ylab,ptcolor='gray',linecolor='k',ptalpha=0.3):
    ...
    cax.errorbar(bc,median,yerr=medianerr,fmt='o-',color=linecolor,rasterized=True, markersize=4)
    #idx = np.argsort(xv)
...
if __name__=='__main__':
    ...
    ax=make_panel(ax,xvalue,yvalue,binvalues,xlimits,ylimits,None,"log group-integrated HI mass")
    ...
    make_panel(ax,xvalue,yvalue,binvalues,xlimits,ylimits,r"log group $M_{\rm vir}$",r"$\log \left( M_{\rm HI,\, grp} \,/\, M_{\rm vir}\right)$",'mediumorchid','purple',0.9)
    ...
    make_panel(ax1,xvalue,yvalue,binvalues,xlimits,ylimits,None,"log group-integrated HI mass")
