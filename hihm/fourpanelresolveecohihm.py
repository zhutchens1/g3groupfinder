...
if __name__=='__main__':
    ...
    ax1.annotate("ECO: G3 Groups", xy=(12.3,7.4), )
    ...
    ax3.annotate("ECO: FoF Groups", xy=(12.3,7.4), )
    ...
    # (1) HI-halo mass relation for centrals, summed-over-satellites, total group-integrated HI
    ax2.annotate("RESOLVE: G3 Groups", xy=(12.3,7.4), )
    centralsel=(ecog3.g3fc_l==1)
    ...
    ax4.annotate("RESOLVE: FoF Groups", xy=(12.3,7.4), )
