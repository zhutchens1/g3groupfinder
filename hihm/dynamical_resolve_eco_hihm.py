...
if __name__=='__main__':
    ...
    #ecog3 = ecog3[ecog3.g3logmhdyn_l>0]
    xvalue = np.zeros(len(ecog3))
    ...
    print(min(xvalue), min(grpn))
    yvalue = ecog3.g3grpmhi_l.to_numpy()
    ax=make_panel(ax,xvalue,yvalue,binvalues,xlimits,ylimits,None,"log group-integrated HI mass",fit=False)
    ...
    resg3 = resg3[resg3.g3logmhdyn_l>0]
    yvalue = resg3.g3grpmhi_l.to_numpy()
    xvalue = resg3.g3logmhdyn_l.to_numpy()
    ...
    make_panel(ax1,xvalue,yvalue,binvalues,xlimits,ylimits,None,"log group-integrated HI mass", fit=False)
